...
_RELEVANT: tuple[tuple[str, str, str, tuple[str, ...]], ...] = (
    ...
    ("privacy", "Owner-only protocol files must never be pushed to the public repo",
     "Understood: owner-only protocol content stays private, never pushed.",
     ("what must stay out of the public repo", "rules for private owner files")),
