...
# One procedure per build/reasoning WorkPattern. Rows use kind values such as
# inspect/verify/edit/report, with "tool" gates for work steps and "final" for the closing report.
