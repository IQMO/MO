...
class TestVoiceRecognizer:
    def test_import_voice_module(self):
        from interface.ghost_desktop.voice import VoiceRecognizer, VoiceSpeaker, CompanionVoice
    ...
    def test_recognizer_available_without_deps(self):
        ...
        from interface.ghost_desktop.voice import VoiceRecognizer
        rec = VoiceRecognizer()
    ...
    def test_companion_voice_constructs(self):
        from interface.ghost_desktop.voice import CompanionVoice
        cv = CompanionVoice()
...
class TestVoiceIntegration:
    ...
    def test_companion_voice_in_init(self):
        ...
        from interface.ghost_desktop import CompanionVoice
        assert CompanionVoice is not None
